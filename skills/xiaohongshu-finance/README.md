...
Skill 内置了多种数据图表和卡片模板，可以一键将干涩的财经分析转为高赞的小红书竖屏美图（1080×1440比例，支持自定义配色与中文字体）：

### 1. 行情快报 (Flex 自由布局)
*AI 根据需求生成的复合多区块排版（KPI看板、涨跌表格、热门标签等）*
![A股强劲反弹](examples/demo_astock.png)

### 2. 深度对比 (Bar 图表模板)
*支持将多维数据渲染为对比清晰的 SVG 可视化图表，并带有下方的总结。*
![中美高股息对比](examples/demo_dividend.png)

### 3. 科普法则 (Card 要点卡片)
*将大段文字拆解为易于阅读的序号列表，直指核心的爆款图文首选。*
![基金定投3大铁律](examples/demo_investing.png)
