...
> 封面图决定点击率。以下模板适用于 Midjourney / Stable Diffusion / DALL-E。

---

## 风格统一说明

小红书财经博主的封面图建议统一为以下风格之一：

| 风格 | 适用场景 | 特点 |
|------|----------|------|
| **数据可视化** | 数据分析、市场解读 | 图表、数字、专业感 |
| **极简文字卡片** | 科普、观点输出 | 大字标题、简洁背景 |
| **扁平插画** | 理财故事、生活场景 | 温馨、亲切、低门槛 |
| **金融商务** | 深度分析、行业研究 | 专业、权威、质感 |
